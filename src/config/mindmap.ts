          ...
          children: [
            {
              id: 'monorepo',
              label: 'Monorepo?',
              note: 'Does a monorepo help or hurt agent context?',
            },
            {
              id: 'docker-eng',
              label: 'Docker-based Engineering?',
              note: 'Isolated per-task environments for every agent run.',
            },
            {
              id: 'fe-be',
              label: 'Frontend / Backend mix?',
              note: 'Which layers benefit most from agent-first workflows?',
            },
            {
              id: 'opps',
